...
class Engine(models.Model):
    ...
    REJ_REASONS = (
        ("MPO", "RTV - Missing Purchase Order Number"),
        ("BIX", "RTV - Bad information"),
        ("DIX", "Reject - Duplicate invoice"),
        ("OTH", "Reject - Other"),
        ("IDX", "Reject - Invalid document"),
        ("WFI", "Reject - Wrong system - Route to FI box"),
        ("WSO", "Reject - Wrong system - Route to SOS box"),
        ("WCO", "Reject - Wrong system - Route to COM box"),
        ("IPO", "RTV - Invalid Purchase Order"),
        ("WCN", "RTV - Wrong company name"),
        ("WCA", "RTV - Wrong company address"),
        ("ICX", "RTV - Incorrect currency"),
        ("MCX", "RTV - Missing currency"),
        ("WVA", "RTV - Wrong VAT amount"),
        ("MVN", "RTV - Missing VAT number"),
        ("VMX", "RTV - Value on the invoice miscalculated"),
        ("DNV", "RTV - Data on the invoice not visible"),
        ("IDM", "RTV - Invoice date missing"),
        ("INM", "RTV - Invoice number missing"),
        ("MPX", "RTV - Missing pages"),
        ("TFM", "RTV - Tax free invoice-note missing"),
        ("DEM", "RTV - Delivery date / Delivery Note Missing"),
        ("QMX", "RTV - Quantity missing"),
        ("SDM", "RTV - Service description missing"),
        ("MIA", "RTV - Missing Invoice Amount"),
        ("IIX", "RTV - Incomplete Invoice"),
        ("MAI", "Reject - Missing Accounting Information"),
        ("IAI", "Reject - Invalid Accounting Information"),
        ("MAX", "Reject - Missing Approval"),
        ("IRA", "Reject - Invalid Remit To Address"),
        ("MRA", "Reject - Missing Remit To Address"),
        ("RNL", "Reject - Remit to address not linked to vendor's record"),
        ("VMX", "Reject - Vendor Master"),
        ("MUI", "Reject - Multiple invoices"),
        ("RES", "Reject:  Rescan, poor quality")
        )
